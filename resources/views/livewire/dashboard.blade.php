                ...
                <div class="flex justify-end px-4 pt-2">
                    ...
                    <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2" aria-labelledby="dropdownButton">
                            <li>
                                <a href="{{ route('settings.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">{{ __('Edit') }}</a>
                            </li>
                        </ul>
{{--                        <div class="py-2">--}}
                ...
                <div class="text-sm mt-4 ml-4 mr-4">
                    ...
                    <p>
                        @if (!empty(auth()->user()->activities()->latest()->first()))
                            <a class="text-large hover-orange dark:text-gray-400" href="{{ route('activities.get', auth()->user()->activities()->latest()->first()->id) }}">
...
<div class="xs:px-1 md:px-2 mt-4 w-full md:w-1/2 lg:w-2/4">
    <div class="w-full">
                ...
                <div class="max-w-full mb-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-4">
                        <div class="flex gap-x-4">
                            ...
                            @if($activity->sport === 2)
                                <svg stroke="currentColor" class="w-6 h-6 stroke-gray-700 dark:text-gray-100" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <title>{{ __('Ride') }}</title>
                            ...
                            <div class="min-w-0 flex-auto">
                                ...
                                <div class="grid text-sm mt-4 grid-cols-1 gap-6 sm:grid-cols-3">
                                    <p class="mb-3 text-left text-gray-700 dark:text-gray-400">
                                        {{ __('Distance') }}<br />
                                        <span class="text-lg">{{ __(':distance km', ['distance' => $activity->getDistance()]) }}</span>
                                    </p>
                                    <p class="mb-3 text-left text-gray-700 dark:text-gray-400">
                                        {{ __('Elevation') }}<br />
                                        <span class="text-lg">{{ __(':elevation m', ['elevation' => $activity->elevation_gain]) }}</span>
                                    </p>
                                    <p class="mb-3 text-left text-gray-700 dark:text-gray-400">
                                        {{ __('Duration') }}<br />
                    ...
                    <div class="p-0">
                        <div class="flex flex-wrap items-center justify-end gap-4" role="group">
                            ...
                            <button type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-transparent hover:text-orange-500 dark:text-orange-500 focus:text-orange-500">
