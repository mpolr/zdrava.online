...
@endsection
{{-- Левый контейнер --}}
<div class="flex flex-col xs:px-1 md:px-2 mt-4 xs:w-full sm:w-full md:w-1/2 lg:w-4/12 xl:w-4/12">
    <div class="w-full">
        ...
        <div class="grid text-sm mt-4 grid-cols-3 gap-6 sm:grid-cols-3">
            <div>
                <button type="button" wire:click="" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    {{ __('Subscribe') }}
                </button>
            </div>
        </div>
...
<div class="flex flex-col xs:px-1 md:px-2 mt-4 xs:w-full sm:w-full md:w-1/2 lg:w-8/12 xl:w-8/12">
    <div class="w-full">
