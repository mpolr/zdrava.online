    ...
    <main class="container mx-auto px-0 py-12">
        <div class="flex">
            <div class="w-2/4 lg:w-3/12 px-4">
                <!-- Боковое меню -->
                <div>
                    <a href="{{ route('app') }}" type="button" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light">
